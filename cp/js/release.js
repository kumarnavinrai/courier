...
function callreleasebillcallreleasebill()
 {
...
if (r==true)
  ...
  var url = sitename+"bills/releasebill.php?a1="+fdx+"&b1="+tdx+"&c1="+ccdx;
  
   /////////////////////////////////////////////////
	   $.ajax({  
              type: "GET", url: sitename+"bills/releasebill.php?a1="+fdx+"&b1="+tdx+"&c1="+ccdx, 
			         complete: function(data){  
                    
	
					$("#mydiv").html(data.responseText);
					document.getElementById("ajaxrtnid").value=data.responseText;
				}  
...
entryxspe.onreadystatechange=function()
  ...
  if (entryxspe.readyState==4 && entryxspe.status==200)
	...
	document.getElementById("ajaxrtnid").value=document.getElementById("mydiv").innerHTML
    }
  }
