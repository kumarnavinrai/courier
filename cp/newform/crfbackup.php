...
<div id="mydivcust"><?php if(isset($ans)){  echo $ans;    } ?> </div>
<div id="cdiv"> 
  ...
  <?php foreach($disp2 as $rr): ?>
    <tr class="table1">
      ...
      <td width="184" height="37" class="txtlbl1"><?php echo $yy['myline']['weight']; ?>
	   ...
	   $name = str_replace(' ','',$name); ?>
        <input name="<?php echo $name; ?>" type="text" class="txtbox1" id="s250" onfocus="color6()" onkeyup="fenter6(event)" size="4"  />
        RS</td>
      <?php endforeach; ?>
      </tr>
      <?php endforeach; ?>
      <tr class="table1">
      <td colspan="4"><input name="sc" type="submit" class="btn1" id="sc"  onkeyup="fenter18(event)" onclick="return validate()" value="SAVE CUSTOMER" />&nbsp;</td>
      </tr>
      </table>
</div>
<!--------
