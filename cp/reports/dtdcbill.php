...
if(isset($_POST['btn_sn'])){  $obj=new billcourier(); list($disp,$sum,$fd,$td)=$obj->cbill(); }
?>
...
<div id="wrapper">
  <div id="wrappersec">
    <div id="head">
      <div id="txtboxdiv"><form id="form2" name="form2" method="post" action="<?php echo SITENAME."print/dtdcbill.php"; ?>">
        <label for="pfd"></label>
        <input type="submit" name="btnbill" id="btnbill" value="PRINT PDF" />
      ...
      <form id="form2" name="form2" method="post" action="<?php echo SITENAME."print/dtdcbillqp.php"; ?>">
        <label for="pfd"></label>
        <input type="submit" name="btnbill" id="btnbill" value="PRINT" />
        <input type="text" name="pfd" id="pfd" value="<?php if(isset($fd)){ echo $fd; } ?>" style="visibility:hidden" />
        <input type="text" name="ptd" id="ptd" value="<?php if(isset($td)){ echo $td; } ?>"  style="visibility:hidden" />
      </form>
      </div>
    ...
    <div id="slogan">COURIER BILL --<a href="<?php echo SITENAME; ?>">GO BACK</a></div>
    <div id="formdiv">
      <div id="txtbtn">
    ...
    <div id="middel">
	<table width="950" border="1" align="center" cellpadding="10" cellspacing="0" ID="table2" bordercolor="#666666" >
  <TBODY>
  <tr>
    <th class="txthead" scope="col">CUSTOMER</th>
    <th class="txthead" scope="col">C NO.</th>
    <th class="txthead" scope="col">DESTINATION</th>
    <th class="txthead" scope="col">WEIGHT</th>
    <th class="txthead" scope="col">P or D</th>
    <th class="txthead" scope="col">BILL AMT</th>
    <th class="txthead" scope="col">AMOUNT</th>
    <th class="txthead" scope="col">DATE</th>
    <th class="txthead" scope="col">NOTES</th>
  </tr>
 ...
 <?php if(isset($disp)){ echo $disp; } ?>
    ...
    <div id="footer">
      <div id="dispmsg">Estemated Bill is : <?php if(isset($sum)){ echo $sum; } ?> Rs Between :<?php if(isset($fd)){ echo $fd; }?> AND :<?php if(isset($td)){ echo $td; } ?></div>
    </div>
  </div>
