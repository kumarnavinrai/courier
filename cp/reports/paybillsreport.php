...
if(isset($_POST['btn_sn'])){  $obj=new billandpayments(); $disp=$obj->paybillsreport(); }
...
$dompdf->render();
$dompdf->stream("paybillsreport.pdf");
}//printing if
  ...
  <div id="wrappersec">
    <div id="head">
      <div id="printdiv"><form id="form2" name="form2" method="post" action="">
       <input type="text" name="disptxt" id="pfd" style="visibility:hidden" value="<?php if(isset($disp)){ echo $disp; } ?>" />
       <input name="btnprint" type="submit" class="txthead" id="btnprint" value="PRINT PDF" />
<label for="ptd"></label>
       <input type="text" name="ptd" id="ptd" style="visibility:hidden" />
      </form>
      <form id="form2" name="form2" method="post" action="">
       <input type="text" name="disptxt" id="pfd" style="visibility:hidden" value="<?php if(isset($disp)){ echo $disp; } ?>" />
       <input name="btnprinttxt" type="submit" class="txthead" id="btnprint" value="PRINT" />
<label for="ptd"></label>
       <input type="text" name="ptd" id="ptd" style="visibility:hidden" />
      </form></div>
      
    </div>
    <div id="slogan">PAID BILLS REPORT-<a href="<?php echo SITENAME; ?>">GO BACK</a></div>
    <div id="formdiv">
      <div id="txtbtn">
