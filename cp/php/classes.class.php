...
//where STR_TO_DATE(releasebills.fd, '%d-%m-%Y')>=STR_TO_DATE('".$this->fd."', '%d-%m-%Y') AND STR_TO_DATE(releasebills.td, '%d-%m-%Y')>=STR_TO_DATE('".$this->td."', '%d-%m-%Y')
	...
	while($rw=mysql_fetch_array($res))
	{
			...
			$rtn.="<tr>";
			$rtn.="<td class='txtr8'>$rw[7]</td>";
			$rtn.="<td class='txtr8'>$temp</td>";
			$rtn.="<td class='txtr8'>$rw[2]</td>";
			$rtn.="<td class='txtr8'>$rw[3]</td>";
			$rtn.="<td class='txtr8'>$rw[4]</td>";
			$rtn.="<td class='txtr8'>$rw[5]</td>";
			$rtn.="<td class='txtr8'>$rw[6]</td>";
			$rtn.="</tr>";	
	...
	while($rw=mysql_fetch_array($res))
	{
			...
			$rtn.="<tr>";
			$rtn.="<td class='txtrr'>$rw[7]</td>";
			$rtn.="<td class='txtrr'>$rw[1]</td>";
			$rtn.="<td class='txtrr'>$rw[2]</td>";
			$rtn.="<td class='txtrr'>$rw[3]</td>";
			$rtn.="<td class='txtrr'>$rw[4]</td>";
			$rtn.="<td class='txtrr'>$rw[5]</td>";
			$rtn.="</tr>";	
			$switch=1;
...
class cnumber{
	...
	function checkcno()
	{
		...
		$res1=$this->obj->fetch($sql1);
						...
						while($rw1=mysql_fetch_array($res1)){
							$custname1=$rw[0];
							if($custname1!=$custname2){
								
								$rtn.="<tr><td class='txtr1234' colspan='9'>  </td></tr>";
								
								$rtn.="<tr><td class='txtr1234' colspan='9'> S No.  $counter </td></tr>";
				$counter++;		$linechange=1;		
								$rtn.=" <tr>
    <th class='txthead1' scope='col'>CUSOMER</th>
    <th class='txthead1' scope='col'>C NO</th>
    <th class='txthead1' scope='col'>DESTINATION</th>
    <th class='txthead1' scope='col'>WEIGHT</th>
    <th class='txthead1' scope='col'>P or D</th>
    <th class='txthead1' scope='col'>B AMT</th>
    <th class='txthead1' scope='col'>AMT</th>
    <th class='txthead1' scope='col'> DATE</th>
    <th class='txthead1' colspan='2' scope='col'>NOTES</th>
    </tr>";
    ...
    <th class='txthead1' colspan='2' scope='col'>NOTES</th>
				...
				if($switch==1){			
					...
					$rtn.="<tr>";
								$rtn.="<td class='txtr8'>$rw[0]</td>";
								$rtn.="<td class='txtr8'>$rw1[0]</td>";
								$rtn.="<td class='txtr8'>$rw1[2]</td>";
								$rtn.="<td class='txtr8'>$rw1[3]</td>";
								$rtn.="<td class='txtr8'>$rw1[4]</td>";
								$rtn.="<td class='txtr8'>$rw1[5]</td>";
								$rtn.="<td class='txtr8'>$rw1[6]</td>";
								$rtn.="<td class='txtr8'>$rw1[7]</td>";
								$rtn.="<td class='txtr8'>$rw1[8]</td>";
								$rtn.="</tr>";
					$switch=1;
...
while($rw=mysql_fetch_array($res)){ 
		...
		$res1=$this->obj->fetch($sql1);
			...
			while($rw1=mysql_fetch_array($res1)){
						  ...
						  if($switch==1){
							$rtn.="<tr>";
							$rtn.="<td class='txtline'>$rw[0]</td>";
							$rtn.="<td class='txtline'>$rw1[0]</td>";
							$rtn.="<td class='txtline'>$rw1[2]</td>";
							$rtn.="<td class='txtline'>$rw1[3]</td>";
							$rtn.="<td class='txtline'>$rw1[4]</td>";
							$rtn.="<td class='txtline'>$rw1[5]</td>";
							$rtn.="<td class='txtline'>$rw1[6]</td>";
							$rtn.="<td class='txtline'>$rw1[7]</td>";
							$rtn.="<td class='txtline'>$rw1[8]</td>";
							$rtn.="</tr>";
							$switch=2;
						  }elseif($switch=2){
							  $rtn.="<tr>";
							$rtn.="<td class='txtxline'>$rw[0]</td>";
							$rtn.="<td class='txtxline'>$rw1[0]</td>";
							$rtn.="<td class='txtxline'>$rw1[2]</td>";
							$rtn.="<td class='txtxline'>$rw1[3]</td>";
							$rtn.="<td class='txtxline'>$rw1[4]</td>";
							$rtn.="<td class='txtxline'>$rw1[5]</td>";
							$rtn.="<td class='txtxline'>$rw1[6]</td>";
							$rtn.="<td class='txtxline'>$rw1[7]</td>";
							$rtn.="<td class='txtxline'>$rw1[8]</td>";
							$rtn.="</tr>";
							$switch=1;
...
while($rw=mysql_fetch_array($res)){ 
		...
		$res1=$this->obj->fetch($sql1);
			...
			while($rw1=mysql_fetch_array($res1)){
					...
					if($switch==1){
						$rtn.="<tr>";
						$rtn.="<td class='txtrr'>$rw[0]</td>";
						$rtn.="<td class='txtrr'>$rw1[0]</td>";													                        $rtn.="<td class='txtrr'>$rw1[2]</td>";								                        $rtn.="<td class='txtrr'>$rw1[3]</td>";
						$rtn.="<td class='txtrr'>$rw1[4]</td>";
						$rtn.="<td class='txtrr'>$rw1[5]</td>";
						$rtn.="<td class='txtrr'>$rw1[6]</td>";
						$rtn.="<td class='txtrr'>$rw1[7]</td>";
						$rtn.="<td class='txtrr'>$rw1[8]</td>";
						$rtn.="</tr>";
						$switch=2;
					}elseif($switch==2){
						
						$rtn.="<tr>";
						$rtn.="<td class='txtrrr'>$rw[0]</td>";
						$rtn.="<td class='txtrrr'>$rw1[0]</td>";													                        $rtn.="<td class='txtrrr'>$rw1[2]</td>";								                        $rtn.="<td class='txtrrr'>$rw1[3]</td>";
						$rtn.="<td class='txtrrr'>$rw1[4]</td>";
						$rtn.="<td class='txtrrr'>$rw1[5]</td>";
						$rtn.="<td class='txtrrr'>$rw1[6]</td>";
						$rtn.="<td class='txtrrr'>$rw1[7]</td>";
						$rtn.="<td class='txtrrr'>$rw1[8]</td>";
						$rtn.="</tr>";
...
while($rw=mysql_fetch_array($res)){ 
		...
		$res1=$this->obj->fetch($sql1);
			...
			while($rw1=mysql_fetch_array($res1)){
								...
								$rtn.="<tr>";
								$rtn.="<td class='txtheadxx'>$rw[0]</td>";
								$rtn.="<td class='txtheadxx'>$rw1[0]</td>";
								$rtn.="<td class='txtheadxx'>$rw1[2]</td>";
								$rtn.="<td class='txtheadxx'>$rw1[3]</td>";
								$rtn.="<td class='txtheadxx'>$rw1[4]</td>";
								$rtn.="<td class='txtheadxx'>$rw1[5]</td>";
								$rtn.="<td class='txtheadxx'>$rw1[6]</td>";
								$rtn.="<td class='txtheadxx'>$rw1[7]</td>";
								$rtn.="<td class='txtheadxx'>$rw1[8]</td>";
...
while($rw=mysql_fetch_array($res)){ 
		...
		$res1=$this->obj->fetch($sql1);
			if($res1){
				...
				$rtn.="<tr>
    <th class='txt' scope='col' colspan='9'>&nbsp;</th>  </tr>";
    ...
    <th class='txt' scope='col'>NOTES</th>
			...
			while($rw1=mysql_fetch_array($res1)){
								...
								$rtn.="<tr>";
								$rtn.="<td class='txtrr'>$rw[0]</td>";
								$rtn.="<td class='txtrr'>$rw1[0]</td>";
								$rtn.="<td class='txtrr'>$rw1[2]</td>";
								$rtn.="<td class='txtrr'>$rw1[3]</td>";
								$rtn.="<td class='txtrr'>$rw1[4]</td>";
								$rtn.="<td class='txtrr'>$rw1[5]</td>";
								$rtn.="<td class='txtrr'>$rw1[6]</td>";
								$rtn.="<td class='txtrr'>$rw1[7]</td>";
								...
								$rtn.="<tr>";
								$rtn.="<td class='txtrrr'>$rw[0]</td>";
								$rtn.="<td class='txtrrr'>$rw1[0]</td>";
								$rtn.="<td class='txtrrr'>$rw1[2]</td>";
								$rtn.="<td class='txtrrr'>$rw1[3]</td>";
								$rtn.="<td class='txtrrr'>$rw1[4]</td>";
								$rtn.="<td class='txtrrr'>$rw1[5]</td>";
								$rtn.="<td class='txtrrr'>$rw1[6]</td>";
								$rtn.="<td class='txtrrr'>$rw1[7]</td>";
						...
						$rtn.="<tr><td colspan='9' class='txtd1' > The amount of courier bill for this customer is : $sumbillcust Rs  </td></tr>";
						$rtn.="<tr><td colspan='9' class='txtd11'> The amount you have charged from this customer is : $sumcust Rs  </td></tr>";
						$temp=$sumcust-$sumbillcust;
						$rtn.="<tr><td colspan='9' class='txtd111'> The income you got from this customer is : $temp Rs  </td></tr>";
						$rtn.="<tr>
    <th class='txt' scope='col' colspan='9'>&nbsp;</th>  </tr>";
...
while($rw=mysql_fetch_array($res)){ 
		...
		$res1=$this->obj->fetch($sql1);
			...
			while($rw1=mysql_fetch_array($res1)){
						...
						$cnme=strtoupper($rw[0]);
						$rtn.="<tr><td class='txtr'>$cnme</td><td class='txtr'>$sumbill</font></td><td class='txtr' >$sumcust</td></tr>"; $sumbill=0; $sumcust=0;
			}//inner res1 if
}//outer while brace
$exp=0;
$sql2="select * from expenses where UNIX_TIMESTAMP(STR_TO_DATE(exdate, '%d-%m-%Y'))>='".$this->fd."' AND UNIX_TIMESTAMP(STR_TO_DATE(exdate, '%d-%m-%Y'))<='".$this->td."'";
	...
	if($res2){ while($rw2=mysql_fetch_array($res2)){ 
	  $ename=strtoupper($rw2[1]);
				$rtn1.="<tr>";
				$rtn1.="<td class='txtr'>$rw2[0]</td>";
				$rtn1.="<td class='txtr'>$ename</td>";
				$rtn1.="<td class='txtr'>$rw2[2]</td>";
				$rtn1.="<td class='txtr' colspan='4'>$rw2[3]</td>";
				$rtn1.="</tr>";	
	$exp=$exp+$rw2[2];
	  } }
