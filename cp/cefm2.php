...
document.getElementById("mind").value=0;
document.getElementById("tind").value=0;
document.getElementById("qind").value=0;
document.getElementById("tempp1kgt").value=0;	
}
...
function parcelweightentery()
{

window.document.getElementById("ndiv").disabled=false;
	//alert("unicode");
var zunicode=document.getElementById("tempp1kgt").value;
...
var unicode=e.keyCode;//? e.keyCode : e.charCode;
document.getElementById("tempp1kgt").value=unicode;
window.document.getElementById("ndiv").disabled=true;
var t = setTimeout("parcelweightentery()",500);
...
<div id="mydiverr"></div>
<label><H3 style="background-color:#990066" align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">PLEASE ENTER DETAILS OF CONSIGNMENT SENT AND SELECT RIGHT ZONE FOR YOUR DESTINATION</font></H3></label>
<div id="qdiv" style="border:3px solid black" align="center" >
<a href="index.php"><img src="BACKB.png" alt="BACK" width="53" height="33" align="top" /></a>
<div id="mdiv" style="border:3px solid black" align="center" >
<div id="ndiv" style="border:3px solid black" align="center" >
<form id="abc" name="abc" action="" >
<p></p>
<table width="944" height="350" id="maintable" >
<tr bgcolor="#FFB9FF">
  <td><table width="962" height="326" id="maintable2" >
    <tr  bgcolor="#990066">
      <td colspan="3" ><font face="Arial, Helvetica, sans-serif" color="#FFFFFF"><span >Fields marked with * are compulsary</span></font></td>
      <td><span>
        <input name="zonestate" type="text" id="zonestate" readonly="readonly" />
      </span></td>
      <td><span class="style1">
        <input name="zonedis8" type="text" id="zonedis8" />
      </span></td>
      <td width="145"><input name="zonecity" type="text" id="zonecity" /></td>
      <td width="149"><input name="pincode" type="text" id="pincode" /></td>
    </tr>
    <tr bgcolor="#FFB9FF">
      <td height="28" colspan="2"><font color="#000033" face="Arial, Helvetica, sans-serif">COURIER NO*</font></td>
      <td width="171"><span class="style1">
        <input name="cuno" type="text" id="cuno" value="Z" onfocus="color1()" tabindex="1" onkeyup="displayunicode11(event)"    />
      </span></td>
      <td><font color="#000033" face="Arial, Helvetica, sans-serif">SPECIAL</font></td>
      <td><select name="spe" id="spe" onfocus="color2()"  onchange="chspe()" tabindex="2" onkeypress="displayunicode12(event)"  >
        <option>yes</option>
    ...
    <tr bgcolor="#990066">
      <td height="39" colspan="2"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF">Destination*</font></td>
      <td><span class="style1">
    ...
    <tr bgcolor="#FFB9FF">
      <td height="38" colspan="2"><font face="Arial, Helvetica, sans-serif" color="#000033">ZONE</font></td>
      <td><span class="Z1">
        <select name="zone" id="zone" onfocus="timepass()" onkeyup="displayunicode13(event)"  >
          <option value="SHIPPER" selected="selected">SHIPPER</option>
          <option value="ZONE">ZONE</option>
          <option value="ROI">REST OF INDIA</option>
          </select>
      </span></td>
      <td><font color="#000033" face="Arial, Helvetica, sans-serif">WEIGHT</font></td>
      <td><span class="style1">
      ...
      <td><span class="style1">
        <label for="spe"></label>
        <input name="p1kgt" type="text" id="p1kgt" value="1" onfocus="color5()" onkeyup="displayunicode15(event)" size="5" />
        <font color="#000033" face="Arial, Helvetica, sans-serif">KG</font></span></td>
      <td>&nbsp;</td>
    </tr>
    <tr  bgcolor="#990066">
      <td height="33" colspan="2"><font  color="#FFFFFF" face="Arial, Helvetica, sans-serif">PARCEL or DOC  </font></td>
      <td height="33"><select name="pord" id="pord" onfocus="color6()" onkeyup="displayunicode16(event)" >
        <option value="parcel">Parcel</option>
        <option value="document" selected="selected">Document</option>
      </select></td>
      <td><font  color="#FFFFFF" face="Arial, Helvetica, sans-serif">CUST CODE*</font></td>
      <td><span class="style1">
        <select name="cucd" id="cucd" onfocus="color7()" onkeyup="displayunicode17(event)" >
...
?>
    ...
    <tr bgcolor="#FFB9FF">
      <td width="54" height="42"><font face="Arial, Helvetica, sans-serif" color="#000033" >DATE*</font></td>
      <td width="91">&nbsp;</td>
      <td><span class="style1">
        <input name="da" type="text" disabled="disabled" id="da"  readonly="readonly"  />
      </span></td>
      <td><span class="style1"><a href="javascript:NewCal('da','ddmmyyyy')" id="imgdh" onfocus="color8()" onclick="displayunicode18(event)"  ><img src="cal.gif" id="imgd" width="53" height="36" border="0" alt="Pick a date"/></a></span></td>
      <td><span class="style1"><font  color="#000033" face="Arial, Helvetica, sans-serif">DD-MM-YYYY</font></span></td>
      <td></td>
      <td></td>
    </tr>
    <tr bgcolor="#990066">
      <td height="33" colspan="2"><!--/*********************for select**************/-->
    ...
    --><font face="Arial, Helvetica, sans-serif"  color="#FFFFFF">AMOUNT BILL</font></td>
      <td><span class="style1">
        <input name="amb" type="text" id="amb" value="0" onfocus="color11()" onkeyup="displayunicode21(event)" />
      </span></td>
      <td colspan="2"><font face="Arial, Helvetica, sans-serif"  color="#FFFFFF">AMOUNT CHARGED</font></td>
      <td><span class="style1">
    ...
    <tr bgcolor="#FFB9FF">
      <td height="44"><font face="Arial, Helvetica, sans-serif"  color="#000033">NOTES</font></td>
      <td colspan="2"><textarea name="note" onfocus="color9()" id="note" cols="45" rows="2" onkeyup="displayunicode19(event)" >empty</textarea></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><input type="button" name="SUB" id="SUB" value="ADD TO BILL" onclick="adde()" onfocus="color10()"     /></td>
      <td>&nbsp;</td>
    </tr>
    </table>    <font color="#000033" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
</tr>
</table>
...
if(unicode ==13 && m==1)
{
var gg=document.getElementById("sctext").value;
