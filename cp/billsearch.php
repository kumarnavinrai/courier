...
<a href="index.php"><img src="BACKB.png" width="75" height="79" alt="BACK" /></a>SEARCH FOR BILL BETWEEN TWO DATES
...
if (r==true)
  ...
  var url = "http://localhost/cp/rpb.php?a1="+fdx+"&b1="+tdx+"&c1="+ccdx;
...
<form  id="WXYZ" name="WXYZ1" method="post" action="http://localhost/cp/rpbexcel.php" style="visibility:hidden">
<p>
<p><H3>
