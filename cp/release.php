...
<script language="javascript" type="text/javascript" src="js/release.js"></script>
...
<div id="wrpmag" >
  ...
  <a href="../welcome.php"><div id="msg">GO BACK TO MENU</div></a>
    <div id="divform">
    <form id="abcf" name="abcf1" method="get"  action="bills/releasebill.php">
      <div id="fddiv">FROM DATE</div>
      <div id="fddivtxt"><input name="a1" type="text"  readonly="readonly" class="txt" id="fd" />
     ...
     <div id="tddiv">TO DATE</div>
      <div id="tddivtxt"><input name="b1" type="text"  readonly="readonly" class="txt" id="td" />
...
CUSTOMER CODE*</div>
<div id="seldiv">
<select name="c1" class="txt" ID="ccd">
...
<div id="btndiv">
    <input name="serchb" type="button" class="btn" id="serchb" onclick="callrpb()" value="SEARCH" /><input name="btnrls" type="submit" class="btnrelease" value="Releasebill" onclick="return callreleasebillcallreleasebill()" /></div>
