...
<div id="middel">
<div class="lbl" id="t1lbl">PAYMENT NUMBER</div><div id="t1text"><input name="a1" type="text" class="txt" id="a1id" /></div><div id="btndiv"><input name="btn" type="button" class="btn" onclick="addf()" value="Search" /></div>
</div>
<div id="foot"></div>
</div>
</div>
