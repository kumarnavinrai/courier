...
if(aa1!=""){
location.href=a+"qtodo/btodo/releasebills/searchbill/"+aa1;
}else{ alert("Enter Bill No"); document.getElementById('a1id').focus(); }
...
<div id="middel">
<div class="lbl" id="t1lbl">BILL NUMBER</div><div id="t1text"><input name="a1" type="text" class="txt" id="a1id" /></div><div id="btndiv"><input name="btn" type="button" class="btn" onclick="addf()" value="Search" /></div>
</div>
<div id="foot"></div>
</div>
</div>
