...
<!--/*********************for select**************/-->
    ...
    <td colspan="3"><span class="style1">DATE*
      ...
      <a href="javascript:NewCal('da','ddmmyyyy')" id="imgdh" onfocus="color8()" onclick="displayunicode18(event)"  ><img src="cal.gif" id="imgd" width="53" height="36" border="0" alt="Pick a date"/></a>    DD-MM-YYYY</span></td>
  </tr>
  <tr>
...
var abc = document.getElementById("des").value;
 ...
 var url = "http://192.168.0.234/cp/serzone.php?a1="+abc;
...
if(zonex=="SHIPPER")
{
var url = "http://192.168.0.234/cp/bills.php?a1="+weightx+"&b1="+pordx+"&c1="+zonex+"&d1="+p1kgtx;
}

if(zonex=="ZONE")
{
var url = "http://192.168.0.234/cp/billz.php?a1="+weightx+"&b1="+pordx+"&c1="+zonex+"&d1="+p1kgtx;}

if(zonex=="ROI")
{
var url = "http://192.168.0.234/cp/billr.php?a1="+weightx+"&b1="+pordx+"&c1="+zonex+"&d1="+p1kgtx;}
