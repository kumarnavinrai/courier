...
var tempc = document.getElementById("cucd").value;	
	...
	var url = "http://localhost/cp/sercust.php?a1="+tempc;
...
<div id="cdiv"> 
<h3 align="center">PAY  CUSTOMER BILL</h3>
<p>
...
&nbsp;<input type="button" value="SEARCH" onclick="cser()"/></p>
...
<table width="805" border="0">
  ...
  <tr>
    <td>CODE
      <label for="cc"></label>
      <input name="cc" type="text" disabled="disabled" id="cc" />
...
if (r==true)
  ...
  var url = "http://localhost/cp/updatecust.php?a1="+cnx+"&b1="+cax+"&c1="+cpx+"&d1="+cex+"&e1="+ccx+"&f1="+s250x+"&g1="+s500x+"&h1="+s1kgx+"&i1="+sp1kgx+"&j1="+z250x+"&k1="+z500x+"&l1="+z1kgx+"&m1="+zp1kgx+"&n1="+r250x+"&o1="+r500x+"&p1="+r1kgx+"&q1="+rp1kgx;
