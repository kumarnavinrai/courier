...
document.abc.note.style.backgroundColor="#FFF";
document.abc.SUB.style.backgroundColor="#FFF";
document.getElementById("imgd").focus();
document.abc.amb.style.backgroundColor="#FFF";
document.abc.amc.style.backgroundColor="#FFF";
...
<table width="900" height="460" border="0">
  ...
  <tr>
    <td><span class="style1">Courier No*
      <input name="cuno" type="text" id="cuno" value="Z" onfocus="color1()" tabindex="1"    />
    </span></td>
    <td colspan="3"><span class="sp1">SPECIAL</span>
      <select name="spe" id="spe" onfocus="color2()"  onchange="chspe()" tabindex="2"  >
        <option>yes</option>
...
<input name="pincode" type="text" disabled="disabled" id="pincode" style="border:none" style="background-color:#CCC"/></td>
  ...
  <tr>
    <td><span class="Z1">ZONE</span><select name="zone" id="zone" onfocus="timepass()" >
  ...
  <tr>
    <td><span class="style1">Weight
      <select name="weight" id="weight"  onchange="selch()" onfocus="color4()" >
      ...
      <input name="p1kgt" type="text" id="p1kgt" value="1" onfocus="color5()" />
      KG    </span></td>
    <td colspan="3"><span class="pord1">PARCEL or DOCUMENT</span><select name="pord" id="pord" onfocus="color6()">
...
<select name="cucd" ID="cucd" onchange="callsdcheck1()" onfocus="color7()" >
...
<!--/*********************for select**************/-->
    ...
    <td colspan="3"><span class="style1">DATE*
      <input name="da" type="text" id="da" onfocus="color8()" readonly="readonly" onkeypress="displayunicode11(event)" />
      <a href="javascript:NewCal('da','ddmmyyyy')"><img src="cal.gif" id="imgd" width="53" height="36" border="0" alt="Pick a date" 	onkeypress="callsdcheck1()" onkeydown="callsdcheck1()" onkeyup="callsdcheck1()"  /></a>    DD-MM-YYYY</span></td>
  </tr>
  <tr>
    <td><span class="style1">AMOUNT BILLED
      <input name="amb" type="text" id="amb" value="0" onfocus="color11()" />
    </span></td>
    <td colspan="3"><span class="style1">AMOUNT CHARGED
      <input name="amc" type="text" id="amc" value="0"  onfocus="color12()" />
    </span></td>
  </tr>
  <tr>
    <td><span class="notes1">NOTES</span><textarea name="note" onfocus="color9()" id="note" cols="45" rows="5">empty</textarea></td>
