...
<!--/*********************for select**************/-->
    ...
    <td colspan="3"><span class="style1">DATE*
      ...
      <a href="javascript:NewCal('da','ddmmyyyy')" id="imgdh" onkeyup="displayunicode18(event)" onfocus="color8()" ><img src="cal.gif" id="imgd" width="53" height="36" border="0" alt="Pick a date" 	 onkeyup="displayunicode19(event)"  /></a>    DD-MM-YYYY</span></td>
  </tr>
  <tr>
